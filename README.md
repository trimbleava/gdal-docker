...
$ docker build . -f Dockerfile -t ghcr.io/trimbleava/dockers/py10-gdal3.8.5:latest
$ docker push ghcr.io/trimbleava/dockers/py10-gdal3.8.5:latest
...
```bash
$ docker pull ghcr.io/trimbleava/dockers:main
$ docker run -it ghcr.io/trimbleava/dockers:main bash
```
